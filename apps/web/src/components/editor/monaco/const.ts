...
3. Working with several pickle slices at a time, toss to evenly coat pickle slices with cornmeal mixture. 
4. Place dredged pickles on prepared lined baking sheet.
`;
